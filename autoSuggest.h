...
void closestWordSearch(std::vector<std::string> &combinations, std::vector<std::string> &closestResponses,
    std::vector<float> &closestResponsesDist, std::vector<std::vector<std::string>>&dictGraph, const std::vector<std::vector<char>>&keyGraph, float &largestMinDist, float weight);
